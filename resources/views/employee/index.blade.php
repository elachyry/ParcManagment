    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Tout les Utilisateurs</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    <br>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <a href="{{route('employee.create')}}" class="btn btn-primary"><i
                            class="bi bi-plus-circle me-1"></i>Ajouter Utilisateur</a>
                            <a href="{{route('employee.export')}}" class="btn btn-success"><i
                            class="bi bi-file-excel me-1"></i>Exporter</a>
                    <a href="{{route('employee.trash')}}" class="btn btn-warning trash"><i
                            class="bi bi-trash me-1"></i>supprimé</a>
                </div>
                <div class="col-lg-2 trash">
                </div>
                <div class="col-lg-4">
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <td class="px-4 py-3" style="text-align:center">
                            <div class="flex items-center space-x-4 text-sm">
                                ...
                                <a href="{{route('mession.choseAffecType',$item->id)}}"
                                    class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                                    aria-label="Edit">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="green"
                                        class="bi bi-layer-forward" viewBox="0 0 16 16">
                                        <path
                                ...
                                <a href="{{route('employee.soft.Delete',$item->id)}}"
                                    class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                                    aria-label="Delete">
        ...
        success: function(res) {
            ...
            if (Array.isArray(res) && res.length == 0) {
                ...
                $.each(res, function(index, value) {
                    ...
                    var url1 = '{{ route("employee.edit", ":id") }}';
                    url1 = url1.replace(':id', value.id);
                    var url2 = '{{ route("employee.soft.Delete", ":id") }}';
                ...
                var url4 = '{{ route("employee.exportSearch", ":id") }}';
