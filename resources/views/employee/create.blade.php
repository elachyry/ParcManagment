...
<main id="main" class="main">
    ...
    <form action="{{route('employee.store')}}" method="post" class="row g-3 needs-validation" novalidate>
    @csrf
                <div class="col-md-6">
                  <label for="validationCustom01" class="form-label">CIN*</label>
                  <input type="text" class="form-control" id="validationCustom01" name="cin" value="" required>
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="validationCustom03" name="last_name" value="" required>
                    <div class="invalid-feedback">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="validationCustom04" name="job" value="" required>
                    <div class="invalid-feedback">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="number" class="form-control" id="validationCustom05" name="phone" value="" required>
                    <div class="invalid-feedback">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="validationCustom06" name="address" value="" >
                  </div>
                ...
                <div class="col-12">
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="invalidCheck">
                      Accepter d'ajouter cette Utilisateur*.
                    </label>
                    <div class="invalid-feedback">
