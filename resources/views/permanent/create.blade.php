...
<main id="main" class="main">
    ...
    <section class="section dashboard">
        <form action="{{route('permanent.store')}}" method="post" class="row g-3 needs-validation" novalidate>
            @csrf
            ...
            <div class="col-md-3">
                ...
                <input type="text" class="form-control" id="first_name" name="first_name"
                    value="{{Request::is('permanent/chosePerm/'.$employee->id) ? $employee->first_name : ''}}" readonly
                    required>
                <div class="invalid-feedback">
            ...
            <div class="col-md-3">
                ...
                <input type="text" class="form-control" id="last_name" name="last_name"
                    value="{{Request::is('permanent/chosePerm/'.$employee->id) ? $employee->last_name : ''}}" readonly
                    required>
                <div class="invalid-feedback">
            ...
            <div class="col-md-3">
                ...
                <input type="text" class="form-control" id="phone" name="phone"
                    value="{{Request::is('permanent/chosePerm/'.$employee->id) ? $employee->phone : ''}}" required
                    readonly>
                <div class="invalid-feedback">
            ...
            <div class="col-md-3" hidden>
                ...
                <input type="text" class="form-control" id="job" name="job"
                    value="{{Request::is('permanent/chosePerm/'.$employee->id) ? $employee->job : ''}}" required readonly>
                <div class="invalid-feedback">
            ...
            <div class="col-md-3" hidden>
                ...
                <input type="text" class="form-control" id="statut" name="statut" value="active" required
                    readonly>
                <div class="invalid-feedback">
                </div>
            </div>
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" id="marque" name="marque" value="{{Request::is('car/chosePerm/'.$car->id) ? $car->marque : ''}}" disabled required>
                <div class="invalid-feedback">
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" id="model" name="model" value="{{Request::is('car/chosePerm/'.$car->id) ? $car->model : ''}}" disabled required>
                <div class="invalid-feedback">
                    Veuillez choisir un model valide.
                </div>
            </div>
            ...
            <div class="col-md-8">
                    ...
                    <textarea class="form-control" name="note" placeholder="poste radio, cric, manivelle..." id="floatingTextarea" style="height: 100px;"></textarea>
            </div>
