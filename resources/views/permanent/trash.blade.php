                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center space-x-4 text-sm">
                                <a href="{{route('permanent.restore',$item->id)}}"
                                ...
                                <form action="{{route('permanent.hard.delete',$item->id)}}" method="post"
...
$('body').on('keyup', '#search', function() {
    ...
    $.ajax({
        method: 'POST',
        url: '{{route("permanent.searchTrash")}}',
        dataType: 'json',
        data: {
            '_token': '{{ csrf_token()}}',
        ...
        success: function(res) {
            ...
            if (Array.isArray(res) && res.length == 0) {
                ...
                $.each(res, function(index, value) {
                    ...
                    var url = '{{ route("permanent.restore", ":id") }}';
                    url = url.replace(':id', value.id);
                    var url1 = '{{ route("permanent.hard.delete", ":id") }}';
