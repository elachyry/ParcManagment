...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Tout les Missions</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    <br>
    ...
    <div class="jumbotron">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <a href="{{route('mession.create')}}" class="btn btn-primary"><i
                            class="bi bi-plus-circle me-1"></i>Ajouter Mission</a>
                    <a href="{{route('mession.export')}}" class="btn btn-success"><i
                    class="bi bi-file-excel me-1"></i>Exporter</a>
                    <a href="{{route('mession.trash')}}" class="btn btn-warning trash"><i
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <td class="px-4 py-3" style="text-align:center">
                            <div class="flex items-center space-x-4 text-sm">
                                <a href="{{route('mession.show',$item->id)}}"
                                ...
                                <a href="{{route('mession.edit',$item->id)}}"
                                    class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                                    aria-label="Edit">
                                ...
                                <a href="{{route('mession.soft.Delete',$item->id)}}"
                                    class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                                    aria-label="Delete">
        ...
        success: function(res) {
            ...
            if (Array.isArray(res) && res.length == 0) {
                ...
                $.each(res, function(index, value) {
                    ...
                    var url = '{{ route("mession.show", ":id") }}';
                    url = url.replace(':id', value.id);
                    var url1 = '{{ route("mession.edit", ":id") }}';
                    url1 = url1.replace(':id', value.id);
                    var url2 = '{{ route("mession.soft.Delete", ":id") }}';
                ...
                var url4 = '{{ route("mession.exportSearch", ":id") }}';
